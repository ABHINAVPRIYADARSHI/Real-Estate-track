    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-2">
        <Link
          ...
          className="flex-1 rounded-md border border-neutral-200 px-3 py-3 text-center text-sm font-medium text-neutral-900 hover:bg-neutral-50 dark:border-neutral-800 dark:text-neutral-100 dark:hover:bg-neutral-900"
        >
          Add Customer
        </Link>
        <Link
          href="/dashboard/visit-logger"
          className="flex-1 rounded-md bg-neutral-900 px-3 py-3 text-center text-sm font-medium text-white dark:bg-neutral-50 dark:text-neutral-900"
        >
          Log Visit
        </Link>
      </div>
